...
namespace 新.Buffs.水魔
{
	public class 水魔二 : ModBuff//继承modbuff类
   {
		...
		public override void Update(Player player, ref int buffIndex)//这个函数是当玩家获得BUFF时每帧执行一次，玩家大多数属性每帧重置
		{
            ...
            player.GetModPlayer<装备效果>().水魔二开 = true;
        }
	}
	public class 地煞霸符 : ModBuff
	{
        public override void SetStaticDefaults()
        {
