...
{
	public class 旋风: ModItem
	{
		public override string Texture => "Terraria/Images/Projectile_704" ;
        

		public override void SetDefaults() 
		{
			Item.damage = 2; // 弹药伤害是和武器叠加作用的，不要设置的太高
			...
			Item.shoot = ProjectileID.DD2ApprenticeStorm;// 代表使用这个弹药会发射什么弹幕
